...
public class AuthController {
	...
	public AuthController(AuthOrchestrator orchestrator, PasswordService passwordService, UserRepository userRepository,
	...
	public ApiResponse<String> register(@RequestParam String email, @RequestParam String password,
	...
	public ApiResponse<String> login(@RequestBody LoginRequest req) {
		return ApiResponse.success(orchestrator.login(req.getEmail(), req.getPassword(), req.isRememberMe()));
	}
