...
(function() {
    ...
    window.showConfirm = function(message, title = 'Confirm', confirmText = 'Confirm', cancelText = 'Cancel', confirmType = 'primary') {
        return new Promise((resolve) => {
            titleEl.textContent = title;
            messageEl.textContent = message;
            const btnClass = confirmType === 'danger' ? 'modal-btn-danger' : 'modal-btn-primary';
            actionsEl.innerHTML = `
